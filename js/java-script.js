...
// Video. Lesson 8 part 2. Iteration array methods
console.log('Video. Lesson 8 part 2. Iteratoin array methods');

// Method sort()
console.log('Method sort()');

const numbersD = [1, 6, 8, 9, 4, 3, 7, 5];
console.log('numbersD before:', numbersD);
// numbersD.sort();
// console.log('numbersD after:', numbersD);
// numbersD.sort((curEl, nextEl) => nextEl - curEl);
// console.log('numbersD doubleafter:', numbersD);

const numbersE = ['A', 'D', 'B', 'F', 'C', 'E'];
console.log('numbersE before:', numbersE);
numbersE.sort();
console.log('numbersE after:', numbersE);
numbersE.sort((curEl, nextEl) => nextEl - curEl);
console.log('numbersE doubleafter:', numbersE);

const copyNumbersD = [...numbersD];
console.log('Copy before:', copyNumbersD);
copyNumbersD.sort();
console.log('Copy after:', copyNumbersD);

// sorting complex data types (objects array)
console.log('Sorting complex data types');
...
console.table(users);
const usersBalance = [...users].sort((minBalance, maxBalance) =>
    minBalance.balance - maxBalance.balance);

console.table(usersBalance);
